...
namespace GnossServicioModuloBaseUsuarios
{
    ...
    internal class SocialSearchController : ControladorServicioGnoss
    {
        ...
        /// <param name="pCancellationToken">Token de cancelaci�n para parar el servicio</param>
        /// <param name="pReplicacion">TRUE si hay que replicar en el servicio de replicaci�n, False caso contrario</param>
        ...
        /// </summary>
        /// <returns>Verdad si ha habido alg�n error</returns>
        ...
        private bool ProcesarFilaDeCola(DataRow pFila)
        {
            using (var scope = ScopedFactory.CreateScope())
            {
                ...
                try
                {
                    ...
                    if (estado < 2)
                    {
                        ...
                        if (pFila["Tipo"].Equals((short)TiposElementosEnCola.Agregado))
                        {
                            ...
                            {
                                //facetadoAD = new FacetadoAD(mFicheroConfiguracionHomeBD, false, mUrlIntragnoss, "ColaReplicaci�nMasterHome", mReplicacion);
                                ...
                                foreach (string idTo in idsTo)
                                {
                                    ...
                                    {
                                        //Los a�ado en la lista, asi si estan en un grupo, no les mando el mensajes dos veces
                                ...
                                //obtenemos informaci�n extra para los destinatarios
                                ...
                                //obtenemos informaci�n extra para los remitentes
                                ...
                                //obtenemos informaci�n extra para los remitentes sobre los destinatarios
                            ...
                            {
                                //facetadoAD = new FacetadoAD(mFicheroConfiguracionBD, false, mUrlIntragnoss, "ColaReplicaci�nMasterHome", mReplicacion);
                                //facetadoAD.CadenaConexionBase = this.mFicheroConfiguracionBDBase;
                                ...
                                //obtenemos informaci�n extra de amigos
                            ...
                            if (!string.IsNullOrEmpty(tripletasMensajesFrom))
                            {
                                ...
                                //Inserto informaci�n de la identidad
                                tripletasMensajesFrom += FacetadoAD.GenerarTripleta("<http://gnoss/" + idString + ">",
                            ...
                            //Una vez se ha insertado en virtuoso los datos de los destinatarios y los que reciben el mensaje, inserto en la cola refrescocach�.
                            if (!string.IsNullOrEmpty(tripletasMensajesTo) || !string.IsNullOrEmpty(tripletasMensajesFrom))
                            {
                                //Enviamos una fila al servicio windows encargado del refresco de la cach� para que muestre el mensaje que se ha recibido.
                            ...
                            if (!string.IsNullOrEmpty(tripletasComentarios))
                            {
                                ...
                                foreach (string idperfil in idsperfil)
                                {
                                    ...
                                    //Si es un comentario editado y el perfil no ha le�do el comentario todav�a, aumentar el contador
                            ...
                            ////Actualizaci�n del �ndice SEARCH.
                ...
                catch (Exception exFila)
                {
                    ...
                    pFila["Estado"] = ((short)pFila["Estado"]) + 1; //Aumento en 1 el error, cuando llegue a 4 no se volver� a intentar
